...
// ISO 3166-1 alpha-2 → Chinese country/region name. Covers every cc present in
// the dataset (245). Anything missing falls back to the English name, so partial
...
export const COUNTRY_ZH: Record<string, string> = {
  ...
  AT: '奥地利', AU: '澳大利亚', AW: '阿鲁巴', AX: '奥兰群岛', AZ: '阿塞拜疆',
  BA: '波斯尼亚和黑塞哥维那', BB: '巴巴多斯', BD: '孟加拉国', BE: '比利时',
  BF: '布基纳法索', BG: '保加利亚', BH: '巴林', BI: '布隆迪', BJ: '贝宁',
  BL: '圣巴泰勒米', BM: '百慕大', BN: '文莱', BO: '玻利维亚', BQ: '博奈尔',
  BR: '巴西', BS: '巴哈马', BT: '不丹', BW: '博茨瓦纳', BY: '白俄罗斯', BZ: '伯利兹',
  CA: '加拿大', CC: '科科斯（基林）群岛', CD: '刚果（金）', CF: '中非共和国',
  CG: '刚果（布）', CH: '瑞士', CI: '科特迪瓦', CK: '库克群岛', CL: '智利',
  CM: '喀麦隆', CN: '中国', CO: '哥伦比亚', CR: '哥斯达黎加', CU: '古巴',
  CV: '佛得角', CW: '库拉索', CX: '圣诞岛', CY: '塞浦路斯', CZ: '捷克',
  ...
  GB: '英国', GD: '格林纳达', GE: '格鲁吉亚', GF: '法属圭亚那', GG: '根西',
  ...
  IE: '爱尔兰', IL: '以色列', IM: '马恩岛', IN: '印度', IQ: '伊拉克', IR: '伊朗',
  ...
  ME: '黑山', MF: '圣马丁（法属）', MG: '马达加斯加', MH: '马绍尔群岛',
  MK: '北马其顿', ML: '马里', MM: '缅甸', MN: '蒙古', MO: '澳门',
  MP: '北马里亚纳群岛', MQ: '马提尼克', MR: '毛里塔尼亚', MS: '蒙特塞拉特',
  MT: '马耳他', MU: '毛里求斯', MV: '马尔代夫', MW: '马拉维', MX: '墨西哥',
  MY: '马来西亚', MZ: '莫桑比克', NA: '纳米比亚', NC: '新喀里多尼亚', NE: '尼日尔',
  NF: '诺福克岛', NG: '尼日利亚', NI: '尼加拉瓜', NL: '荷兰', NO: '挪威',
  NP: '尼泊尔', NR: '瑙鲁', NU: '纽埃', NZ: '新西兰', OM: '阿曼', PA: '巴拿马',
  ...
  WS: '萨摩亚', XK: '科索沃', YE: '也门', YT: '马约特', ZA: '南非', ZM: '赞比亚',
  ZW: '津巴布韦',
};

/** Country/region name in the chosen language; falls back to the English name. */
export function countryName(cc: string, en: string, lang: Lang): string {
  if (lang === 'zh') return COUNTRY_ZH[(cc || '').toUpperCase()] || en;
  return en;
}
